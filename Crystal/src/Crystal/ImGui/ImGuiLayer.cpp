...
// 		colors[ImGuiCol_HeaderActive] = ImVec4{ 0.03627, 0.26141, 0.3659, 1.0f };
		...
		// Buttons
		colors[ImGuiCol_Button] = ImVec4{ 0.047f, 0.431f, .839, 1.0f };
		colors[ImGuiCol_ButtonHovered] = ImVec4{ 0.06547f, 0.5431f, .9839, 1.0f };
		colors[ImGuiCol_ButtonActive] = ImVec4{ 0.037f, 0.331f, .739, 1.0f };

		// Tabs
		colors[ImGuiCol_Tab] = ImVec4{ 0.047f, 0.431f, .839, 1.0f };
		colors[ImGuiCol_TabHovered] = ImVec4{ 0.0547f, 0.5431f, .9839, 1.0f };
		colors[ImGuiCol_TabActive] = ImVec4{ 0.04547f, 0.54431f, .9339, 1.0f };
		colors[ImGuiCol_TabUnfocused] = ImVec4{ 0.047f, 0.431f, .839, 1.0f };
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4{ 0.047f, 0.431f, .839, 1.0f };
	}
