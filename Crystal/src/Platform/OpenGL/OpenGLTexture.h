...
namespace Crystal
{
	...
	public:
		...
		inline virtual const TextureSpecification& GetSpecification() const override { return m_Specification; }
		...
		virtual void SetFilteringMode(bool nearestFiltering) override;
