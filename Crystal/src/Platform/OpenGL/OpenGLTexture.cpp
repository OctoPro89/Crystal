...
namespace Crystal
{
	namespace Utils
	{
		static GLenum CrystalImageFormatToGLDataFormat(ImageFormat format)
		{
			switch (format)
			{
			...
			CRYSTAL_CORE_ASSERT(false, "Cannot use specified image format!");
			return 0;
		}

		static GLenum CrystalImageFormatToGLInternalFormat(ImageFormat format)
		{
			switch (format)
			{
		...
		: m_Specification(specification), m_Width(m_Specification.Width), m_Height(m_Specification.Height)
	{
		...
		m_InternalFormat = Utils::CrystalImageFormatToGLInternalFormat(m_Specification.Format);
		m_DataFormat = Utils::CrystalImageFormatToGLDataFormat(m_Specification.Format);
